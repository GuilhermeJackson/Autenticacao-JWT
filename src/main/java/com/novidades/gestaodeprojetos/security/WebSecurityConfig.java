...
public class WebSecurityConfig {
    ...
    @Bean
    public JWTAuthteticationFilter authenticationJwtTokenFilter() {
        return new JWTAuthteticationFilter();
    }
    ...
    // metodo parão pra configurar o nosso CustomUserDetailsService com nosso metodo
    // de codificar a senha
    @Bean
